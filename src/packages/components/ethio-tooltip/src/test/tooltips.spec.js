...
const tests = [
  ...
  { name: "tooltip", selector: () => document.querySelector(".ethio-tooltip") },
];
...
tests.forEach(({ name, selector: containerSelector }) => {
  describe(`tooltips initialized at ${name}`, () => {
    ...
    beforeEach(() => {
      ...
      tooltipBody = body.querySelector(".ethio-tooltip__body");
      tooltipTrigger = body.querySelector(".ethio-tooltip__trigger");
      tooltipWrapper = body.querySelector(".ethio-tooltip");
    });
    ...
    it("trigger is created", () => {
      assert.strictEqual(
        ...
        "ethio-button ethio-tooltip__trigger",
      );
    });
    ...
    it("should not allow for innerHTML of child elements ", () => {
      ...
      body.innerHTML = `<button class="ethio-button ethio-tooltip" title="Apricot &lt;img src='' onerror=alert('ouch')&gt;">Button</button>`;
      tooltip.on();
      tooltipBody = body.querySelector(".ethio-tooltip__body");
      tooltipTrigger = body.querySelector(".ethio-tooltip__trigger");
      tooltip.on(body);
