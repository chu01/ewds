...
const tests = [
  ...
  {
    name: "combo box",
    selector: () => document.querySelector(".ethio-combo-box"),
  },
];
  ...
  describe(`Combo box initialized at ${name}`, () => {
    describe("combo box component", () => {
      ...
      beforeEach(() => {
        ...
        ComboBox.on(root);
        input = root.querySelector(".ethio-combo-box__input");
        toggle = root.querySelector(".ethio-combo-box__toggle-list");
        select = root.querySelector(".ethio-combo-box__select");
        status = root.querySelector(".ethio-combo-box__status");
        list = root.querySelector(".ethio-combo-box__list");
      });
      ...
      it("enhances a select element into a combo box component", () => {
        ...
        assert.ok(
          select.classList.contains("ethio-sr-only"),
        ...
        assert.ok(
          select.classList.contains("ethio-combo-box__select"),
      ...
      it("should focus the first item in the list when pressing down from the input", () => {
        ...
        assert.ok(
          focusedOption.classList.contains(
            "ethio-combo-box__list-option--focused",
          ),
