...
describe("navigation toggle", () => {
  ...
  beforeEach(() => {
    ...
    accordion.on();
    navigation.on();
    header = body.querySelector(".ethio-header");
    nav = body.querySelector(".ethio-nav");
    navControl = body.querySelector(".ethio-nav__link");
    overlay = body.querySelector(".ethio-overlay");
    closeButton = body.querySelector(".ethio-nav__close");
    menuButton = body.querySelector(".ethio-menu-btn");
    accordionButton = nav.querySelector(".ethio-accordion__button");
