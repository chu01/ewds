...
describe("Date picker button without wrapping element", () => {
  ...
  beforeEach(() => {
    ...
    DatePicker.on();
    button = body.querySelector(".ethio-date-picker__button");
    expectedError = "";
  ...
  it('should throw an error when a toggle button is clicked without a wrapping "ethio-date-picker"', () => {
    expectedError = "Element is missing outer .ethio-date-picker";
    EVENTS.click(button);
