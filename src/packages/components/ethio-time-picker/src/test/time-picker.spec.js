...
const EVENTS = require("../../../ethio-combo-box/src/test/events");

const TEMPLATE = fs.readFileSync(
  path.join(__dirname, "/time-picker.template.html"),
);

const timePickerSelector = () => document.querySelector(".ethio-time-picker");
const tests = [
...
tests.forEach(({ name, selector: containerSelector }) => {
  describe(`time picker component initialized at ${name}`, () => {
    ...
    beforeEach(() => {
      ...
      root = body.querySelector(".ethio-combo-box");
