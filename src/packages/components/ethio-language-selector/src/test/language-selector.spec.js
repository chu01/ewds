...
describe("language selector component", () => {
  ...
  beforeEach(() => {
    ...
    language = body.querySelector(".ethio-language-container");
    languageList = body.querySelector(".ethio-language__submenu");
    languageButton = body.querySelector(".ethio-language__link");
