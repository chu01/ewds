...
const rangeSliderSelector = () => document.querySelector(".ethio-range");
  ...
  describe(`Range slider with span initialized at ${name}`, () => {
    describe("range slider component", () => {
      ...
      beforeEach(() => {
        ...
        // get the closest slider with class .ethio-range__wrapper
        wrapperDiv = slider.closest(".ethio-range__wrapper");
        spanElement = wrapperDiv.querySelector(".ethio-range__value");
      });
