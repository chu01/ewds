...
const THE_NAV = ".ethio-in-page-nav";
const PRIMARY_CONTENT_SELECTOR =
  ".ethio-in-page-nav-container .ethio-in-page-nav .ethio-in-page-nav__list";
...
const assertHidden = (el, hidden) => {
  assert.strictEqual(
    window.getComputewdstyle(el).display === "none",
    hidden,
...
const tests = [
  ...
  {
    name: "in page nav",
    selector: () => document.querySelector(".ethio-in-page-nav"),
  },
];
...
tests.forEach(({ name, selector: containerSelector }) => {
  describe(`in-page navigation initialized at ${name}`, () => {
    ...
    it("assigns id to section headings", () => {
      ...
      const ok = [
        "h2 > .ethio-anchor#section-1",
        "h2 ~ h3 > .ethio-anchor#section-1-1",
        "h2 ~ h3 ~ h3 > .ethio-anchor#section-1-2-2",
        "h2 ~ h3 ~ h3 ~ h3 > .ethio-anchor#section-1-3",
        "h2 ~ h3 ~ h3 ~ h3 ~ h3 > .ethio-anchor[id='1-4-section-1-4']",
