...
const PRIMARY_CONTENT_SELECTOR =
  ".ethio-footer--big .ethio-footer__primary-content--collapsible .ethio-list";
const BUTTON_SELECTOR = ".ethio-footer__primary-link";
...
const tests = [
  ...
  { name: "footer", selector: () => document.querySelector(".ethio-footer") },
];
