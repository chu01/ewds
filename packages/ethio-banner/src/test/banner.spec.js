...
const EXPANDED_CLASS = "ethio-banner__header--expanded";
const HIDDEN = "hidden";

const tests = [
  { name: "document.body", selector: () => document.body },
  { name: "banner", selector: () => document.querySelector(".ethio-banner") },
];
...
tests.forEach(({ name, selector: containerSelector }) => {
  describe(`Banner initialized at ${name}`, () => {
    ...
    beforeEach(() => {
      ...
      header = body.querySelector(".ethio-banner__header");
      button = body.querySelector(".ethio-banner__button");
      content = body.querySelector(".ethio-banner__content");
