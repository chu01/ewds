...
const modalWindowSelector = () => document.querySelector(".ethio-modal");
...
tests.forEach(({ name, selector: containerSelector }) => {
  describe(`Modal window initialized at ${name}`, () => {
    ...
    beforeEach(() => {
      ...
      modalWrapper = body.querySelector(".ethio-modal-wrapper");
      overlay = body.querySelector(".ethio-modal-overlay");
      openButton1 = openButton1Selector();
      openButton2 = openButton2Selector();

      comboList = comboListSelector();
      comboBoxToggleButton = body.querySelector(".ethio-combo-box__toggle-list");
    });
    ...
    describe("Builds the modal HTML", () => {
      ...
      it("moves the modal to the bottom of the DOM", () => {
        assert.strictEqual(
          body.lastElementChild.classList.contains("ethio-modal-wrapper"),
          true,
        );
      });
