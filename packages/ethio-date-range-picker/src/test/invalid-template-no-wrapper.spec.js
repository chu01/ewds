...
describe("Date range picker button without wrapping element", () => {
  ...
  beforeEach(() => {
    ...
    rangeStartInputEl = body.querySelector(
      ".ethio-date-range-picker__range-start .ethio-date-picker__external-input",
    );
    rangeEndInputEl = body.querySelector(
      ".ethio-date-range-picker__range-end .ethio-date-picker__external-input",
    );
    expectedError = "";
  ...
  it('should throw an error when the range start value is changed without a wrapping "ethio-date-range-picker"', () => {
    expectedError = "Element is missing outer .ethio-date-range-picker";
    rangeStartInputEl.value = "12/12/2020";
    EVENTS.input(rangeStartInputEl);
    assert.strictEqual(error, expectedError, "caught the error");
  });

  it('should throw an error when the range end value is changed without a wrapping "ethio-date-range-picker"', () => {
    expectedError = "Element is missing outer .ethio-date-range-picker";
