...
const dateRangePickerSelector = () =>
  document.querySelector(".ethio-date-range-picker");
const tests = [
...
tests.forEach(({ name, selector: containerSelector }) => {
  describe(`date range picker component with min date and max date initialized at ${name}`, () => {
    ...
    beforeEach(() => {
      ...
      rangeStart = root.querySelector(".ethio-date-range-picker__range-start");
      rangeEnd = root.querySelector(".ethio-date-range-picker__range-end");
      rangeStartInputEl = rangeStart.querySelector(
        ".ethio-date-picker__external-input",
      );
