  ...
  describe(`File input initialized at ${name}`, () => {
    describe("file input component builds successfully", () => {
      ...
      beforeEach(() => {
        ...
        dropZone = body.querySelector(".ethio-file-input__target");
        instructions = body.querySelector(".ethio-file-input__instructions");
        inputEl = body.querySelector(".ethio-file-input__input");
        box = body.querySelector(".ethio-file-input__box");
        dragText = body.querySelector(".ethio-file-input__drag-text");
        statusMessage = body.querySelector(".ethio-sr-only");
      });
      ...
      it("instructions are created", () => {
        assert.strictEqual(
          ...
          "ethio-file-input__instructions",
        );
      });
      ...
      it("input gets new class", () => {
        assert.strictEqual(
          ...
          "ethio-file-input__input",
        );
      });

      it("box is created", () => {
        assert.strictEqual(box.getAttribute("class"), "ethio-file-input__box");
      });
      ...
      it("creates a status message element", () => {
        assert.strictEqual(statusMessage.getAttribute("class"), "ethio-sr-only");
      });
