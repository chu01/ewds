...
const inputMaskingSelector = () => document.querySelector(".ethio-input-masking");
const tests = [
...
tests.forEach(({ name, selector: containerSelector }) => {
  describe(`input mask component initialized at ${name}`, () => {
    ...
    beforeEach(() => {
      ...
      input = root.querySelector(".ethio-input");
    });
    ...
    it("formats a US zip code to 12345-6789", () => {
      ...
      EVENTS.input(input);
      shell = root.querySelector(".ethio-input-mask--content");
